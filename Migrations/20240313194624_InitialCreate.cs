        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Background = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    ...
                    PersonalityTraits = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    Ideals = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    Bonds = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    Flaws = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    ...
                    Eyes = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Skin = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Hair = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Subclass = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CharacterHealths", x => x.HealthID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CharacterStatistics", x => x.StatisticID);
                    table.ForeignKey(
                        name: "FK_CharacterStatistics_Characters_CharacterID",
                        column: x => x.CharacterID,
                        principalTable: "Characters",
                        principalColumn: "CharacterID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CharacterHealths_CharacterID",
